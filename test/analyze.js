...
describe('analyze', function () {
    ...
    describe('object', function () {
        ...
        it('IncorrectRowIndex', async function () {
            ...
            const [error1, error2, error3, error4] = errors
            assert.ok(
                error1 instanceof Errors.IncorrectHeaderRow,
                `Expected error to be an instance of 'IncorrectHeaderRow' but got: '${error1.constructor.name}'`
            )
            assert.ok(
                error2 instanceof Errors.IncorrectHeaderRow,
                `Expected error to be an instance of 'IncorrectHeaderRow' but got: '${error2.constructor.name}'`
            )
            assert.ok(
                error3 instanceof Errors.IncorrectHeaderRow,
                `Expected error to be an instance of 'IncorrectHeaderRow' but got: '${error3.constructor.name}'`
            )
            assert.ok(
                error4 instanceof Errors.IncorrectHeaderRow,
                `Expected error to be an instance of 'IncorrectHeaderRow' but got: '${error4.constructor.name}'`
            )
        ...
        it('IncorrectColumnIndex', async function () {
            ...
            const [error1, error2, error3, error4] = errors
            assert.ok(
                error1 instanceof Errors.IncorrectHeaderColumn,
                `Expected error to be an instance of 'IncorrectHeaderColumn' but got: '${error1.constructor.name}'`
            )
            assert.ok(
                error2 instanceof Errors.IncorrectHeaderColumn,
                `Expected error to be an instance of 'IncorrectHeaderColumn' but got: '${error2.constructor.name}'`
            )
            assert.ok(
                error3 instanceof Errors.IncorrectHeaderColumn,
                `Expected error to be an instance of 'IncorrectHeaderColumn' but got: '${error3.constructor.name}'`
            )
            assert.ok(
                error4 instanceof Errors.IncorrectHeaderColumn,
                `Expected error to be an instance of 'IncorrectHeaderColumn' but got: '${error4.constructor.name}'`
            )
    ...
    describe('MultiCellHeaders', async function () {
        ...
        it('IncorrectRowIndex', async function () {
            ...
            assert.ok(
                error5 instanceof Errors.IncorrectHeaderRow,
                `Expected error to be an instance of 'IncorrectHeaderRow' but got: '${error5.constructor.name}'`
            )
        ...
        it('IncorrectColumnIndex', async function () {
            ...
            assert.ok(
                error5 instanceof Errors.IncorrectHeaderColumn,
                `Expected error to be an instance of 'IncorrectHeaderColumn' but got: '${error5.constructor.name}'`
            )
